...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def switch_features_handler(self, ev):
        ...
        if dpid == 1: # switch S1
            #10.0.0.1 is dst ip address, 10 is priority, 1 is switch port number
    ...
    # Member methods to call to install TCP/UDP/ICMP fwding rules
    ...
    # Member methods to call to install general rules
