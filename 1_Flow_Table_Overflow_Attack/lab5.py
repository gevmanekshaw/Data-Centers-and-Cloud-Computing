...
class SimpleSwitch13(app_manager.RyuApp):
	...
	tpd = tp.dst_port	
        ...
        self.logger.info("packet in %s %s %s %s", src, dst, tps, tpd )
	self.logger.info("pkt is %s %s %s", eth, tp, nw)
        ...
        if out_port != ofproto.OFPP_FLOOD:
            match = parser.OFPMatch( ip_proto=6, eth_type=0X800, 
					ipv4_src=nw.src, ipv4_dst=nw.dst, 
